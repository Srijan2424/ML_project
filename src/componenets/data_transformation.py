# purpose id to perform feature engineering ,EDA, and preprocessing 
import os
import sys 
...
# inputs for data transformation config
@dataclass
    ...
    def get_data_transformer_object(self):
        try:
            ...
            num_pipeline=Pipeline(
                steps=[
                    # handles the missing values by replacing them with the median 
                    ("imputer",SimpleImputer(strategy="median")),
                    # performing standard scalar on the numerical data
            ...
            cat_pipeline=Pipeline(
                steps=[
                    # handles the missing values by replacing them with the mode value
